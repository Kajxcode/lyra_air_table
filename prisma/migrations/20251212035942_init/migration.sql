...
-- CreateEnum
CREATE TYPE "FilterOperator" AS ENUM ('CONTAINS', 'NOT_CONTAINS', 'EQUALS', 'NOT_EQUALS', 'IS_EMPTY', 'IS_NOT_EMPTY', 'GREATER_THAN', 'LESS_THAN');
...
CREATE TABLE "ColumnState" (
    ...
    CONSTRAINT "ColumnState_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Cell_columnId_valueText_idx" ON "Cell"("columnId", "valueText");

-- CreateIndex
CREATE INDEX "Cell_columnId_valueNumber_idx" ON "Cell"("columnId", "valueNumber");
...
-- CreateIndex
CREATE UNIQUE INDEX "ColumnState_viewId_columnId_key" ON "ColumnState"("viewId", "columnId");
...
-- AddForeignKey
ALTER TABLE "ColumnState" ADD CONSTRAINT "ColumnState_viewId_fkey" FOREIGN KEY ("viewId") REFERENCES "View"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ColumnState" ADD CONSTRAINT "ColumnState_columnId_fkey" FOREIGN KEY ("columnId") REFERENCES "Column"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
